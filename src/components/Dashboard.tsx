    ...
    >
      ...
      <motion.div variants={itemVariants} className={`relative overflow-hidden rounded-3xl bg-gradient-to-r ${theme.heroGradient} p-8 sm:p-10 text-white shadow-xl border ${theme.heroOuterBorder}`}>
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="max-w-2xl space-y-4">
            ...
            <div className="pt-2">
              <a 
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#25D366] hover:bg-[#128C7E] text-white rounded-full font-bold text-sm transition-all shadow-lg hover:shadow-xl active:scale-95 border border-white/20"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 shrink-0 w-full md:w-auto md:max-w-md lg:max-w-lg mt-6 md:mt-0">
            <button
            ...
            >
              <Radio className="h-5 w-5 text-rose-500 mb-1" />
